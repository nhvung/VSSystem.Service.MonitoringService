...
{
    class CheckBackupWorker : PoolWorker
    {
        EProcessType _processType;
        EComponentType _componentType;
        IProcess _process;
        public CheckBackupWorker(EComponentType componentType, EProcessType processType, bool enabled, string serviceName, int interval, int numberOfThreads, ALogger logger)
        : base(new IntervalWorkerStartInfo("CheckBackupWorker_" + componentType + "_" + processType, enabled, serviceName, interval, numberOfThreads, EWorkerIntervalUnit.Second), logger)
        {
            _processType = processType;
            _componentType = componentType;
            _initPoolFolderAction = delegate
            {
                _poolFolder = new System.IO.DirectoryInfo(ServiceConfig.pools_backup_folder + $"/Request/{_componentType}/{_processType}");
            };
